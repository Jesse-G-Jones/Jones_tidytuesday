...
labs(title="2018-2020 Monthly Average Player Count of CS:GO, Dota 2, and PUBG", #this is the title of my plot
  ...
  ggsave(here("Tidy_Tuesday 2023-04-06", "Output", "GamesPlot.jpg"),
         height=6, width=14)